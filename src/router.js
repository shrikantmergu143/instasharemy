...
const Login = Loader(lazy(() => import('src/auth/Login')));
const Register = Loader(lazy(() => import('src/auth/Register')));
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: 'overview',
        element: ( <Navigate to="/dashboards/index" replace/>)
      },
      {
        path: 'status',
        children: [
  ...
  },
  {
    ...
    children: [ {path: '/', element: (<Navigate to="/dashboards/index" replace/>)},
                {path: 'index', element: <Crypto />},
                {path: 'messenger', element: <Messenger />}
      ]
  },
  {path: 'management', element: (<SidebarLayout />),
      children: [ {path: '/',element: (<Navigate to="/management/transactions" replace/>)},
  ...
  { path: 'components',element: (<SidebarLayout />),
        children: [{path: '/', element: (<Navigate to="/components/buttons" replace/>)},
